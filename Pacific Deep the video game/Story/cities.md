...
At the beginning of the game the player character starts as a newly-built engineering robot in Research and Development City. The player has the option to explore all the different cities (maybe needing to do some sort of quests to unlock the access to some of them)
...
There are Laputian robots or machines that can kind of "sing" (they have soundproducing bodyparts, which are pretty much equivalent to synthesizers with loudspeakers). There are dozens (maybe more than hundred) different kind of singing voices (or different kind of synthesizer instruments). New singing voices (or synthesizer instruments) can be uncovered as the game progresses.

Within this city, there is a music hall where the singing robots perform concerts, which are scheduled about daily or weekly or so.

There might be a repertoire of about 100 classical Laputian music pieces. Some of those might be lost initially, but which can be uncovered by the player as the game progresses. The performer robots sing those pieces in the concerts, and the player may also invent an "mp3 player" through which the player may listen to any uncovered music piece at any time (this is the primary way of having background music; the minigames may contain musical pieces of their own).
